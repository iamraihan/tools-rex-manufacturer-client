...
import { FaPlane, FaMoneyCheckAlt, FaGift, FaHeadphonesAlt } from "react-icons/fa";
        ...
        <div className='max-w-screen-xl mx-auto bg-warning shadow-xl rounded-lg grid lg:grid-cols-4 md:grid-cols-2 gap-5'>
            ...
            <div className=" flex items-center p-5 ">
                ...
                <div>
                    ...
                    <p className='text-secondary'>Offer special bonuses with gift
                    </p>
                </div>
            </div>
            <div className=" flex items-center p-5 ">
                ...
                <div>
                    ...
                    <p className='text-secondary'>Call us 24/7 at 123-456-789
                    </p>
                </div>
            </div>
